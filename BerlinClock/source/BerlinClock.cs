...
namespace BerlinClock.source
{
    ...
    class BerlinClock
    {
        public static void Main()
        {
            ...
            Console.WriteLine("\n\n **** Testcase 2 **** \n");
            BerlinClockFinder berlinClockfinder = new BerlinClockFinder("R", "Y", "O");
            Console.WriteLine(berlinClockfinder.formatToBerlinClock(time)+"\n");

            //Test case 3: Red light as R, yellow as G for green and off as B for black
            Console.WriteLine("\n\n **** Testcase 3 **** \n");
            berlinClockfinder = new BerlinClockFinder("R","G","B");
            Console.WriteLine(berlinClockfinder.formatToBerlinClock(time)+"\n");

            //Test case 4: Input as datetime object with current time
            Console.WriteLine("\n\n **** Testcase 4 **** \n");
            berlinClockfinder = new BerlinClockFinder("R", "Y", "O");
            Console.WriteLine("Current Time is "+DateTime.Now.ToString("HH:mm:ss") + "\n");
            Console.WriteLine("In Berlin clock format "+berlinClockfinder.formatToBerlinClock(DateTime.Now)+"\n");
            ...
            Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(hour,minute,second) + "\n");
            ...
            {
                berlinClockfinder = new BerlinClockFinder("R", "Y", "O");
                Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(Int32.Parse(hour), Int32.Parse(minute), Int32.Parse(second)) + "\n");
            }
            ...
            Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(DateTime.Now.ToString("hh:mm:ss tt")) + "\n");
            ...
            Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(DateTime.Now.ToString("tt hh:mm:ss")) + "\n");
            ...
            Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(DateTime.Now.AddHours(3).ToString("tt hh:mm:ss")) + "\n");
            ...
            Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(DateTime.Now.ToString("MM/dd/yy hh:mm:ss tt ")) + "\n");
            ...
            Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(DateTime.Now.AddHours(3).ToString("MM/dd/yy hh:mm:ss tt ")) + "\n");
            ...
            Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(DateTime.Now.ToString("MM/dd/yy HH:mm:ss ")) + "\n");
            ...
            Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(DateTime.Now.ToString("HH:mm:ss MM/dd/yy")) + "\n");

            //Test case 15: Date and time format with date coming later
            Console.WriteLine("\n\n **** Testcase 15 **** \n");
            berlinClockfinder = new BerlinClockFinder("R", "Y", "O");
            Console.WriteLine("The Time is " + DateTime.Now.ToString("MM/dd/yy") + "\n");
            Console.WriteLine(berlinClockfinder.formatToBerlinClock("MM/dd/yy") + "\n");

            //Test case 16: different time format
            Console.WriteLine("\n\n **** Testcase 16 **** \n");
            berlinClockfinder = new BerlinClockFinder("R", "Y", "O");
            Console.WriteLine("The Time is " + DateTime.Now.AddHours(12).ToString("h:mm:ss.ff t") + "\n");
            Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(DateTime.Now.AddHours(12).ToString("h:mm:ss.ff t")) + "\n");

            //Test case 17: different time format
            Console.WriteLine("\n\n **** Testcase 17 **** \n");
            berlinClockfinder = new BerlinClockFinder("R", "Y", "O");
            Console.WriteLine("The Time is " + DateTime.Now.ToString("h:mm:ss.ff t") + "\n");
            Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(DateTime.Now.ToString("h:mm:ss.ff t")) + "\n");

            //Test case 18: Without time
            Console.WriteLine("\n\n **** Testcase 18 **** \n");
            berlinClockfinder = new BerlinClockFinder("R", "Y", "O");
            Console.WriteLine("The Time is " + DateTime.Now.ToString("d MMM yyyy") + "\n");
            Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(DateTime.Now.ToString("d MMM yyyy")) + "\n");

            //Test case 19: different time format
            Console.WriteLine("\n\n **** Testcase 19 **** \n");
            berlinClockfinder = new BerlinClockFinder("R", "Y", "O");
            Console.WriteLine("The Time is " + DateTime.Now.ToString("HH:mm:ss.f") + "\n");
            Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(DateTime.Now.ToString("HH:mm:ss.f")) + "\n");

            //Test case 20: 
            Console.WriteLine("\n\n **** Testcase 20 **** \n");
            berlinClockfinder = new BerlinClockFinder("R", "Y", "O");
            Console.WriteLine("The Time is " + DateTime.Now.ToString("dd MMM HH:mm:ss") + "\n");
            Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(DateTime.Now.ToString("dd MMM HH:mm:ss")) + "\n");

            //Test case 21: 
            Console.WriteLine("\n\n **** Testcase 21 **** \n");
            berlinClockfinder = new BerlinClockFinder("R", "Y", "O");
            Console.WriteLine("The Time is " + DateTime.Now.ToString("HH:mm:ss.ffffzzz") + "\n");
            Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(DateTime.Now.ToString("HH:mm:ss.ffffzzz")) + "\n");

            //Test case 22: 
            Console.WriteLine("\n\n **** Testcase 22 **** \n");
            berlinClockfinder = new BerlinClockFinder("R", "Y", "O");
            Console.WriteLine("The Time is " + DateTime.Now.ToString("zzzHH:mm:ss.ffff") + "\n");
            Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(DateTime.Now.ToString("zzzHH:mm:ss.ffff")) + "\n");

            //Test case 23: 
            Console.WriteLine("\n\n **** Testcase 23 **** \n");
            berlinClockfinder = new BerlinClockFinder("R", "Y", "O");
            Console.WriteLine("The Time is " + DateTime.Now.AddHours(12).ToString("zzzHH:mm:ss.ffff") + "\n");
            Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(DateTime.Now.AddHours(12).ToString("zzzHH:mm:ss.ffff")) + "\n");

            //Test case 24: 
            Console.WriteLine("\n\n **** Testcase 24 **** \n");
            berlinClockfinder = new BerlinClockFinder("R", "Y", "O");
            Console.WriteLine("The Time is " + DateTime.Now.AddHours(12).ToString("ffffzzzHH:mm:ss") + "\n");
            Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(DateTime.Now.AddHours(12).ToString("ffffzzzHH:mm:ss")) + "\n");

            //Test case 25: 
            Console.WriteLine("\n\n **** Testcase 25 **** \n");
            berlinClockfinder = new BerlinClockFinder("R", "Y", "O");
            Console.WriteLine("The Time is " + DateTime.Now.ToString("ffffzzzHH:mm:ss") + "\n");
            Console.WriteLine("In Berlin clock format " + berlinClockfinder.formatToBerlinClock(DateTime.Now.ToString("ffffzzzHH:mm:ss")) + "\n");
